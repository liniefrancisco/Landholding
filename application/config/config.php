...
|--------------------------------------------------------------------------
|
| URL to your CodeIgniter root. Typically this Awill be your base URL,
...
|
*/
$config['encryption_key'] = '6tfmRaLyAuXinJf9ZX63l6yBRuV5xUIo'; //6tfmRaLyAuXinJf9ZX63l6yBRuV5xUIo
...
|
*/
$config['sess_driver'] = 'files'; //files or database
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 1800; //30 mins
$config['sess_save_path'] =  NULL; //APPPATH . 'ci_sessions/'; 
//Added by Linie
// $config['sess_save_path'] = 'C:/laragon/tmp';
...
$config['csrf_exclude_uris'] = array('/land_holding/Account');
...
//     if (stripos($_SERVER["REQUEST_URI"],$csrf_off)) {
//         $config['csrf_protection'] = FALSE;
//     }
// } 

// // solution 1
// if (stripos($_SERVER["REQUEST_URI"],'/land_holding/Land/profile') === FALSE) {
// 	$config['csrf_protection'] 	= FALSE;
// }else{ 
...
// }
 ...
 // solution 2;
				// $csrf_ignore = [
				// 	'/land_holding/Welcome/validate_credentials',
				// 	'/land_holding/Land/view_document',
				// 	'/land_holding/Notification',
				// 	'/land_holding/Account',
				// 	'land_holding/Welcome/get_time_active',
				// ];
