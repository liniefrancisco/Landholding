...
class Acquisition extends App_Controller{
	...
	public function get_rpt_details() {
    	$region = $this->input->post('region');
    	$province = $this->input->post('province');
    	$town = $this->input->post('town');

    	$result = $this->Acquisition_model->get_rpt_details('lot_location', $region, $province, $town);
	...
	public function get_table_data_by_citymun(){
		$citymunCode = $this->input->post('citymunCode');
		$result = $this->Acquisition_model->get_table_data($citymunCode);
