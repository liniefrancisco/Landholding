                  ...
                  <div class="row row_container">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="x_panel animate  fadeInLeft" style="box-shadow: 5px 8px 16px #888888">
                              ...
                              <?php echo form_open_multipart('Legal_f/aspayment/extrajudicial', array('id' => 'add_lot')); //start form here ?>
                              ...
                              <div class="col-md-12 form_border">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12 space">
                                      ...
                                      <div class="ccol-md-3 col-sm-3 col-xs-3">
                                          <input type="text" class="form-control input_border text-center" name="ostreet" id="ostreet"
                                              value="<?php echo set_value('street') ?>" required>
                                          <h6 class="name_center"><i>Street</i></h6>
                                      </div>
                                      <div class="ccol-md-3 col-sm-3 col-xs-3">
                                          <input type="text" class="form-control input_border text-center" name="ozipcode"
                                              id="ozipcode" value="<?php echo set_value('zipcode') ?>" readonly>
