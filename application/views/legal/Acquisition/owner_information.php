...
<div class="right_col" role="main">
	<div class="row row_container">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<!--====================FLASH DATA====================-->
			<?php if(($this->session->flashdata('notif')=='Land Information Saved Successfully!')){?>
			...
			<div class="x_panel animate slideInDown" style="border:1px; !important;box-shadow: 7px 6px 16px #888888;">
				<div class="x_title">
					...
					<div class="pull-right">
						<form action="<?= base_url('Old_Acquisition/cancel_acq_land_info/'.$li['is_no']); ?>" onsubmit="return confirm('Are you sure to cancel this Acquisition?');" method="POST">
							<button type="submitt" name="cancel_acq_owner" class="btn btn-warning" style="background-color: #e65c00;"><i class="glyphicon glyphicon-floppy-remove"></i> Cancel</button>
						</form>
					</div>
					<div class="clearfix"></div>
				</div>

				<?php echo form_open('Old_Acquisition/owner_info/'.$li['is_no'], array('id' => 'add_own'));  ?>
					<!--====================BODY====================-->
					<div class="x_panel" style="border-radius:9px; ">
						<div class="row">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 form-inline" style="padding-top: 15px;padding-bottom: 15px;">
								<h2 style="color:#1a1a1a;font-size:15px;display:inline;padding-left: 10px;"><b>Presentor:</b></h2>
								<label><span style="padding-left: 88px;"><input type="radio" id="" name="presentor" class="appearance" value="Owner/Seller" <?php if (@$_POST['presentor'] == "Owner/Seller"){ echo "checked"; } ?> required>Owner/Seller</label>
								<label><span style="padding-left: 70px;"><input type="radio" id="" name="presentor" class="appearance" value="Broker" <?php if (@$_POST['presentor'] == "Broker"){ echo "checked"; } ?> required>Broker</label><br>
							</div>          
							...
							<div class="col-md-12 col-sm-12 col-xs-12 form-inline" style="padding-top: 15px;padding-bottom: 15px;">
								...
								<label><span style="padding-left: 105px;"><input type="radio" name="gender" value="Male" required <?php if(@$_POST['gender'] == "Male"){ echo "checked"; } ?>><label class="control-label">Male</label>
								</label>
								<label><span style="padding-left: 120px;"><input type="radio" name="gender" value="Female" required <?php if(@$_POST['gender'] == "Female"){ echo "checked"; } ?>><label class="control-label">Female</label>
								</label>
							</div>
