			...
			<div class="x_panel animate slideInDown" style="border:1px; !important;box-shadow: 7px 6px 16px #888888;">
				<div class="x_title">
					...
					<div class="pull-right">
						<form action="<?= base_url('Secretary/Acquisition/cancel_acq_upload_intf/'.$id) ?>" method="POST" onsubmit="return confirm('Are you sure to cancel all the informations you have inputed?');">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<center id="LT" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_lt()'));?>
							...
							<center id="TCT" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_tct()'));?>
									<div class="container2 col-md-offset-2">
										<?php if(!$ud['tct'] == null){ ?>      
											<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<center id="DOS" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_dos()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="eCar" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_ecar()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="TD" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_td()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="TC" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_tc()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="LS" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_ls()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="VM" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_vm()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="CNI" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_cni()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="RET" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_ret()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="MC" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_mc()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="BC" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_bc()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="VI" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_vi()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="SP" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_sp()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="SPA" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_spa()'));?>
									<div class="container2 col-md-offset-2">
										<?php if(!$ud['spa'] == null){ ?>      
											<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<center id="DENR" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_denr()'));?>
									<div class="container2 col-md-offset-2">
							...
							<center id="OTHER" class="titling" style="display: none;">
								<?php echo form_open_multipart('Legal/Registry/upload_owner_requirements/'.$li['is_no'], array('onsubmit' => 'return validate_other()'));?>
									<div class="container2 col-md-offset-2">
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												...
												?>
													<div class="image-container">
														...
														<form action="<?= base_url('Legal/Registry/upload_owner_requirements/' . $ud['is_no']) ?>" method="post" class="delete-form">
...
<script type="text/javascript">
	document.addEventListener("DOMContentLoaded", function(event) {
		...
		$(".send").click(function(){
			var id = $(this).attr("id");
			$.ajax({
				url: "<?php echo base_url('Secretary/Acquisition/send_documents/'); ?>" + id,
				type: "post",
				data: {
				...
				success: function (response) {
					...
					if (response.success) {
						window.location.replace("<?php echo base_url('Secretary/Acquisition/pop_up_upload/'); ?>" + id);
					} else {
