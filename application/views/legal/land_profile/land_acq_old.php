        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="tab">
                <a href="<?php echo base_url('Legal_f/Land/land_acq_old'); ?>"> <button class="tablinks active">
                    <b>OLD ACQUISITION</b></button></a>
                <a href="<?php echo base_url('Legal_f/Land/land_acq_new'); ?>"> <button class="tablinks">
...
$(document).ready(function(){
  $("#old_acquisition").DataTable({
    "serverSide": true,
      ajax: {
        url: '<?= site_url('Legal_f/Land/fetch_land_datatable/acquisition');?>',
        data:{
          tag:'Old'
        },
        type: "POST",
