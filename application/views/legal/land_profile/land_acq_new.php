      ...
      <div class="x_panel" style="box-shadow: 5px 8px 16px #888888">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="tab">
                <a href="<?php echo base_url('Legal_f/Land/land_acq_old'); ?>"> <button class="tablinks ">
                    <b>OLD ACQUISITION</b></button></a>
                <a href="<?php echo base_url('Legal_f/Land/land_acq_new'); ?>"> <button class="tablinks active">
