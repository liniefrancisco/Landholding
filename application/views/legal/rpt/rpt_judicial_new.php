        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="tab">
                <a href="<?php echo base_url('Legal_f/Rpt/rpt_judicial_old'); ?>"> <button class="tablinks ">
                    <b>OLD ACQUISITION</b></button></a>
                <a href="<?php echo base_url('Legal_f/Rpt/rpt_judicial_new'); ?>"> <button class="tablinks active">
