				...
				<div class="x_panel" style="border-radius:10px;">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-4 col-sm-4 col-xs-4" id="oct">
							<?php if(!$ud['oct'] == null){  ?>
								<?php
					                $oct_path = base_url('assets/img/es_uploads/' . $ud['is_no'] . '/OCT/' . $ud['oct']);
					            ?>
						...
						<div class="col-md-4 col-sm-4 col-xs-4"  id="tct">
							<?php if(!$ud['tct'] == null){ ?>
								<?php
					                $tct_path = base_url('assets/img/es_uploads/' . $ud['is_no'] . '/TCT/' . $ud['tct']);
					            ?>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 space">
						<div class="col-md-5 col-sm-5 col-xs-5 text-center">
				            ...
				            <?php $doubtful_account_path = base_url('assets/img/es_uploads/' . $eu['reference_id'] . '/Doubtful Account/' . $eu['doubtful_account']); ?>
						...
						<div class="col-md-3 col-sm-3 col-xs-3 text-center">
				            ...
				            <?php $latest_soa_path = base_url('assets/img/es_uploads/' . $eu['reference_id'] . '/Latest Soa/' . $eu['latest_soa']); ?>
						...
						<div class="col-md-4 col-sm-4 col-xs-4 text-center">
				            ...
				            <?php $supporting_docs_path = base_url('assets/img/es_uploads/' . $eu['reference_id'] . '/Supporting Docs/' . $eu['supporting_docs']); ?>
