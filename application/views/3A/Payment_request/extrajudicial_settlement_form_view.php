...
<div class="right_col" role="main">
	<div class="row row_container"> 
		...
		<?php if($payment_request['status'] == 'Pending' && $payment_request['type'] == 'Collateral') { ?>
            <div class="col-md-12 space">
                <div class="col-md-9"></div>
                <div class="col-md-3" style="position: fixed;width: 250px;bottom: 20px;right: 10px;z-index: 99;cursor: pointer;">
                    <button style="float: right;border-radius: 10px;" class="btn btn-xs btn-danger" data-dismiss="modal" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target=".disapproved_es_<?php echo $payment_request['is_no']; ?>" title="Disapproved"><span class="fa fa-close"></span> <b>Disapproved</b>
                    </button>

                    <button style="float: right;border-radius: 10px;" class="btn btn-xs btn-info" data-dismiss="modal" data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target=".approved_es_<?php echo $payment_request['is_no']; ?>" title="Approved"><span class="fa fa-check-square-o"></span> <b>Approved</b>
                    </button>
                </div>
            </div>
        <?php } ?>
...
<!--====================APPROVED MODAL FULL PAYMENT====================-->
<div class="modal fade approved_es_<?php echo $payment_request['is_no'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"style="background:#5bc0de;">
                ...
                <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-ok"></span> Approve</h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn  btn-info approved" id="<?php echo $payment_request['is_no'] ?>">Yes</button>
...
<!--====================DISAPPROVED MODAL FULL PAYMENT====================-->
<div class="modal fade disapproved_es_<?php echo $payment_request['is_no'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn  btn-info disapproved" id="<?php echo $payment_request['is_no'] ?>">Send</button>
...
<script>
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        $(".approved").click(function () {
            var id = $(this).attr("id");
            $.ajax({
                url: "<?php echo base_url('GM/Payment_request/submit_approved_es/"+id+"') ?>",
                type: "post",
                data: { '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>' },
                success: function () {
                    window.location.replace("<?php echo base_url('GM/Payment_request/pop_up_approved/"+id+"') ?>");
                }
            });
        });
        //END APPROVED FULL PAYMENT
        ...
        $(".disapproved").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('GM/Payment_request/submit_disapproved_es/"+id+"') ?>",
                type: "post",
                data: {
                    'is_no': id,
                ...
                success: function (data) {
                    window.location.replace("<?php echo base_url('GM/Payment_request/pop_up_disapproved') ?>/" + id + "");
                }
            });
        });
