...
<!-- start content ======================================================================================================================================= -->
                  <div class="x_panel animate zoomIn" style="box-shadow: 5px 8px 16px #888888">
                       <div class="x_title">
                            <h2 style="word-spacing: 4px; letter-spacing: 1px; font-weight: bold; font-size: 14px;color: #2a3f54; "><i class="fa fa-legal"></i> Judicial Settlement</h2>
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 form_border">
                                      <center class="space">
                                          <img src="<?= base_url('assets/logo/AGC.jpg') ?>" width="200px" height="50px">
                                                                <h4>LAND AS PAYMENT FORM - JUDICIAL SETTLEMENT (LAPF-JS)</h4>
                                      </center>
                                      <div class="col-md-12 col-sm-12 col-xs-12 space">
                                              <div class="col-md-4 col-sm-4 col-xs-4 form-inline">
                                                    <label>LAPF-JS #:</label><input class="form-control input_border" type="text" name="js_no" value="<?php echo $li['is_no'] ?>"  readonly>
                                              </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 space" style="border-top: 2px solid #ff6600; border-bottom: 1px solid #ff6600;">
                                              <h5>CUSTOMER BALANCE INFORMATION</h5>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12 space">
                                              <div class="col-md-4 col-sm-4 col-xs-4"><label>Case Type:</label></div>
                                              <div class="col-md-4 col-sm-4 col-xs-4"><input type="checkbox" value="" name="" <?php if($cbal['case_type'] == "Small claim case"){ echo "checked"; } ?>><label>Small claim case</label></div>
                                              <div class="col-md-4 col-sm-4 col-xs-4"><input type="checkbox" value="" name="" <?php if($cbal['case_type'] == "Collection of Sum Money"){ echo "checked"; } ?>><label>Collection of Sum Money</label></div>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12"> 
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 space">
                                              <div class="col-md-4 col-sm-4 col-xs-4 form-inline"><label>Bid Price: ₱</label><input type="text" name="" value="<?php echo number_format($bd['bid_price'],2) ?>" class="form-control input_border" readonly></div>
                                              <div class="col-md-6 form-inline"><label>Status:</label><input type="text" name="" value="<?php echo $bd['highest_bidder'] ?>" class="form-control input_border" readonly><label>Highest Bidder</label></div>
                                        </div>
                              </div>
