      ...
      <div class="x_panel" style="box-shadow: 5px 8px 16px #888888">
        <div class="x_title">
          <h2 style="word-spacing: 4px; letter-spacing: 1px; font-weight: bold; font-size: 14px;color:#2a3f54;"><i
              class="fa fa-database" style="font-size: 16px;"></i>JUDICIAL</h2>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="tab">
                <a href="<?php echo base_url('Ccd/Requests/pending_judicial'); ?>"> <button id="button1"
                    class="tablinks"><i class="fa fa-ellipsis-h"></i> <b>PENDING</b><sup> <span
                        class="badge_custom bg-orange">
                        <?php echo $pending_js; ?>
                      </span></sup></button></a>
                <a href="<?php echo base_url('Ccd/Requests/approved_judicial'); ?>"> <button id="button2"
                    class="tablinks"><i class="fa fa-thumbs-up"></i>
                    <b>APPROVED</b><sup> <span class="badge_custom" style="background-color:green">
                        <?php echo $app_js; ?>
                      </span></sup></button></a>
                <a href="<?php echo base_url('Ccd/Requests/disapproved_judicial'); ?>"> <button id="button3"
                    class="tablinks active"><i class="fa fa-thumbs-down"></i>
                ...
                <div class="card shadow">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <h4 class="request"><b>Disapproved Acquisition</b></h4>
                      <table class="table table-hover" id="old_acquisition">
                        <thead style="background-color:#00538C">
                          <tr>
                            ...
                            <th class="fw-bold" style="color: white">DATE DISAPPROVED</th>
                            <th class="fw-bold" style="color: white">DISAPPROVED BY</th>
...
<script>
  $(document).ready(function () {
    $("#old_acquisition").DataTable({
      "serverSide": true,
      ajax: {
        url: '<?= site_url('Ccd/Land/fetch_js_es_land/judicial'); ?>',
        data: {
          tag: 'Disapproved',
        },
        type: "POST",
