			...
			<div class="x_panel animate  fadeInLeft" style="box-shadow: 5px 8px 16px #888888">
				...
				<div class="x_panel" style="border-radius:10px;">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 space"> 
						...
						<div class="col-md-3 col-sm-3 col-xs-3">
							<input class="form-control input_border txt_cent" type="text" value="<?php echo $ca['country'] ?>" readonly>
							<h6 class="txt_cent"><i>Country</i></h6>
						</div>
						<div class="col-md-3 col-sm-3 col-xs-3">
							<input class="form-control input_border txt_cent" type="text" value="<?php echo $ca['zip_code'] ?>" readonly>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 space">
                        <div class="col-md-4 col-xs-4 col-sm-4 form-inline">
                            <label>Lot :</label>
                            <input class="form-control input_border" type="text" value="<?php echo $li['lot'] ?>" readonly>
                        </div>
                        <div class="col-md-4 col-sm-4  col-xs-4 form-inline pull-right">
                            <label>Cad :</label>
                            <input class="form-control input_border" type="text" value="<?php echo $li['cad'] ?>" readonly>
                        </div>
                    </div>
