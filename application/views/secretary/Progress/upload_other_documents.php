			...
			<div class="nav-tabs-responsive">
				...
				<div class="col-md-12" >
					...
					<center id="LT" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_lt()'));?>
					...
					<center id="TCT" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_tct()'));?>
							<div class="container2 col-md-offset-2">
								<?php if(!$ud['tct'] == null){ ?>      
									<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<center id="DOS" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_dos()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="eCar" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_ecar()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="TD" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_td()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="TC" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_tc()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="LS" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_ls()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="VM" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_vm()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="CNI" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_cni()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="RET" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_ret()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="MC" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_mc()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="BC" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_bc()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="VI" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_vi()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="SP" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_sp()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="SPA" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_spa()'));?>
							<div class="container2 col-md-offset-2">
								<?php if(!$ud['spa'] == null){ ?>      
									<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<center id="DENR" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_denr()'));?>
							<div class="container2 col-md-offset-2">
					...
					<center id="OTHER" class="titling" style="display: none;">
						<?php echo form_open_multipart('Payment/upload_owner_documents/'.$is_no, array('onsubmit' => 'return validate_other()'));?>
							<div class="container2 col-md-offset-2">
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										?>
											<div class="image-container">
												...
												<form action="<?= base_url('requests/resubmit_requirements/' . $ud['is_no']) ?>" method="post" class="delete-form">
													<input type="hidden" name="file_name" value="<?= trim($fileName) ?>">
													<div class="col-md-8">
														<button type="submit" name="delete_other" class="delete-button"><i class="fa fa-trash-o text-danger"></i> Delete</button>
													</div>
												</form>
											</div>
										<?php } ?>
...
<!--====================MODAL FOR APPROVAL====================-->
<div class="modal fade app_<?php echo $li['is_no']?>"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" style="margin-top: 100px;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background:#6b8e23;">
				...
				<h5 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-ok" style="color:white;"></i><span style="color:#E7E7E7;"> Resubmit Documents</span></h5>
			</div>
			<div class="modal-body" style="overflow-y: auto;">
				<center><h6><span style="font-family:verdana; font-size:15px">Are you sure you want to send these documents?</span></h6></center>
				<center><p><span style="font-family:verdana; font-size:15px">Please review before proceeding.</span></p></center>
			</div>
...
<script type="text/javascript">
	document.addEventListener("DOMContentLoaded", function(event) {
		...
		$(".resubmit").click(function(){
			var id = $(this).attr("id");
			$.ajax({
				url: "<?php echo base_url('Secretary/Documents/resubmit_docu/"+id+"')?>",
				type: "post",
				data: {'<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'},
				success:function(){
					// alert("The Request has been Approved");
					window.location.replace("<?php echo base_url('Secretary/Documents/pop_up_resubmit/"+id+"') ?>");
				}
			});
		});
		//RESUBMIT JQUERY
...
<script>
	document.getElementById('edit_other').addEventListener('click', function () {
		// Find all elements with the class "delete-button" and hide them
...
<style type="text/css">
	.container2 {
		position: relative;margin-top: 50px;width: 500px;height: 300px;
	}
	.overlay2 {
		position: absolute;top: 0;left: 0;width: 67%;height: 90%;background: rgba(0, 0, 0, 0);transition: background 0.5s ease;
	}
	.container2:hover .overlay2 {
		display: block;background: rgba(0, 0, 0, .3);
	}
	.title2 {
		position: absolute;width: 500px;left: 0;top: 120px;font-weight: 700;font-size: 30px;text-align: center;text-transform: uppercase;color: white;z-index: 1;transition: top .5s ease;
	}
	.container2:hover .title2 {
		top: 90px;
	}
	.upload_btn {
		position: absolute;width: 500px;left:0;top: 180px;text-align: center;opacity: 0;transition: opacity .35s ease;
	}
	.upload_btn a {
		width: 200px;padding: 12px 48px;text-align: center;color: white;border: solid 2px white;z-index: 1;margin-left: -158px;
	}
	...
	label.small {
		font-variant: small-caps;font-size: 0.900em;letter-spacing: 2px;color: #595959;
	}
	i.small {
		font-variant: small-caps;font-size: 0.900em;letter-spacing: 3px;color: #006bb3;
	}
	.file-name-label{
		overflow:hidden;text-overflow:ellipsis;width: 128px;height: 14px;margin-top: 10px;display:block;float: left;
	}
</style>