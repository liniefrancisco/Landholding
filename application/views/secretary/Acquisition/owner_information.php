			...
			<div class="x_panel animate slideInDown" style="border:1px; !important;box-shadow: 7px 6px 16px #888888;">
				<div class="x_title">
					...
					<div class="pull-right">
						<form action="<?= base_url('Acquisition/cancel_acq_land_info/'.$li['is_no']); ?>" onsubmit="return confirm('Are you sure to cancel this Acquisition?');" method="POST">
				...
				<?php echo form_open('Acquisition/owner_info/'.$li['is_no'], array('id' => 'add_own'));  ?>
					<!--====================BODY====================-->
