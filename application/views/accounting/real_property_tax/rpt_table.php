  ...
  <div class="row row_container">  
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel animate fadeIn" style="border:1px; !important;box-shadow: 7px 6px 16px #888888;"> 
        <center><h5 class="title_ca">STATEMENT OF ACCOUNT</h5></center>
...
<style>
  .title_ca{
    font-weight:bold;padding-top:10px;font-family:Times New Roman;font-size:16px;letter-spacing: 2px
  }
  .title_municipality{
    font-weight:bold;font-family:Times New Roman;font-size:12px;letter-spacing: 1px;text-transform:uppercase;
  }
  .th_ca{
    text-align:center
  }
